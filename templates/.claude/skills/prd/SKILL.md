...
3. Read `.claude/rules/agent-guide.md` for tech stack
...
6. Also create native tasks using TaskCreate with appropriate blockedBy/blocks relationships
7. Set `## Dependencies:` headers based on the dependency ordering
8. Update `docs/spec/.llm/STRATEGY.md` with the new tasks
9. Present the task list with dependency graph to the user
